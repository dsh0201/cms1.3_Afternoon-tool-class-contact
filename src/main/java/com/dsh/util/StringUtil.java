...
public class StringUtil {
	...
	public static String randomChineseString() {
		...
		// 地位1-94
		int low = 176+Math.abs(random.nextInt(93));
		byte b1 = new Integer(high).byteValue();
		byte b2 = new Integer(low).byteValue();
		byte[] b = new byte[2];
		b[0] = b1;
		b[1] = b2;
		String str= null;
	...
	// 方法3：返回参数length个中文汉字字符串，字符集必须在GB2312(相当于中文简体)范围内，例如“中呀被”
	...
	public static String generateChineseName() {
		String[] suname= { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨", "朱", "秦",
				...
				// 姓氏
				String name1=suname[RandomUtil.random(0,suname.length-1)];
				// 名称
